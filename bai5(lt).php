        ...
        <section>
            <div class="row" style="clear: both;">
                ...
                <div>
                        ...
                        <div style="height: 20px;"></div>
                        <div>
                            <p>Trước khi vào vấn đề thì bạn cần phải biết đơn vị byte và bit, hai đơn vị này se có công thức chuyển đổi như sau: <b>1 byte = 8 bit</b> . Mỗi bit sẽ là một ô nhớ trong bộ nhớ máy tính. Mình chỉ giải thích các kiểu dữ liệu chuẩn, còn các kiểu định nghĩa bởi <b style="color: #0b7ae9;">sign và unsign</b>  thì bạn tự tính toán nhé.</p>
                        </div>
                        <div style="height: 20px;"></div>
                        <div>
