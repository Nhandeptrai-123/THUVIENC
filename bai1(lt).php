    ...
    <div class="container-fluid">
        ...
        <section>
            <div class="row" style="clear: both;">
                ...
                <b style="font-size: 55px;">Ngôn ngữ C++ là gì? Dùng làm gì trong công nghệ thông tin?</b>
                <div style="height: 20px;"></div>
                <hr>
                <div style="height: 20px;"></div>
                <p>
               ...
               <div>
                    ...
                    <div style="height: 20px;"></div>
                    <div>
                        <p>Nói đến C++ thì không thể không nhắc đến những điểm mạnh của nó dưới đây:</p>
                    </div>
                    <div style="height: 20px;"></div>
                    <div>
