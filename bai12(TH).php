...
//      các loại như int, char, float, v.v.
    ...
    cout&lt;&lt;"Chương trình này được đăng tại Freetuts.net";
                        ...
                        <div style="height: 20px;"></div>
                        <p><strong>Kết quả:</strong> Khi chúng ta khai báo mảng arr[ ] = {11, 22, 33, 44, 55, 66} thì kết quả sẽ là 6.</p>
                        <div>
                            <img src="imageBai_12_TH/dem-so-phan-tu.jfif" alt="" class="w-100">
                        </div>
                        
                        <div style="height: 20px;"></div>
                        <p>Như vậy là chúng ta đã thực hiện xong chương trình C++ để đếm số phần tử trong mảng. Chúc các bạn thực hiện thành công!!!</p>
                    </div>
               </div>
                <div style="height: 20px;"></div>
                <hr>
                ...
                <div style="float: left;width: 100%;display: flex;">
                    <p id="bt" ><a href="bai11(TH).html">⇦ Bài trước </a></p>
                    <p id="bs"><a href="bai1(TH).html">Bài tiếp theo ⇨</a></p>
                </div>
               <div style="height: 50px;"></div>
                </div>
