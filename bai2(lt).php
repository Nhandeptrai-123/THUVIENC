...
<body>
    ...
    void main()
    {
        cout &#60;&#60; "Hello World!"&#60;&#60; endl;
                ...
                <div>
                        ...
                        <div style="height: 20px;"></div>
                        <div>
                            <p>Khi chúng ta lập trình một phần mềm hoặc một chương trình dù nhỏ hay lớn thì đều phải thao tác với các thiết bị của máy tính như bàn phím, chuột, màn hình ... để nhận dữ liệu nhập vào và in kết quả trả về.</p>
                        </div>
                        <div style="height: 20px;"></div>
                        <div>
                            <p>Vấn đề đặt ra là để thao tác được với các thiết bị đó thì chúng ta sẽ phải lập trình thì máy tính mới giao tiếp được, nhưng công việc đó không hề đơn giản và mất thời gian. Vì vậy người ta đã viết sẵn ra các thư viện để khi muốn sử dụng thì chỉ cần khai báo.</p>
                        </div>
                        <div style="height: 20px;"></div>
                        <div>
                            <p>Thư viện trong lập trình là một khái niệm mà mọi người sẽ bắt gặp rất nhiều ở hầu hết các ngôn ngữ lập trình. Ta có thể định nghĩa nôm na như sau:</p>
                        </div>
                        <div style="height: 20px;"></div>
                        <div>
    ...
    Thư viện trong lập trình là nơi cung cấp sẵn cho chúng ta những hàm những phương thức có thể sử dụng được ở nhiều chương trình giúp rút ngắn thời gian lập trình lại. Hiện nay hầu hết các trình soạn thảo C++ luôn cung cấp đầy đủ các thư viện cần thiết giúp lập trình viên có thể khai thác được một cách dễ dàng. Các thư viện luôn được tích hợp sẵn trong các trình soạn thảo code nhưng khi chúng ta bắt đầu viết code vẫn phải có thao tác đó là khai báo những thư viện nào cần cho chúng ta khi code.
                        ...
                        <div style="height: 20px;"></div>
                        <div>
                            <p>Để khai báo sử dụng thư viện trong C++ thì ta sử dụng cú pháp sau:</p>
                        </div>
                        <div style="height: 20px;"></div>
                        <div>
    ...
    #include &#60;Tên thư viện&#62;
                        ...
                        <div style="height: 20px;"></div>
                        <div>
                            <p>Từ khoá <b>#include</b> chỉ cho trình biên dịch biết rằng chúng ta cần sử dụng thư viện được khai báo và nó sẽ tự động thêm vào cho chúng ta.</p>
                        </div>
                        <div style="height: 20px;"></div>
                        <div>
                            <p>Tôi xin giới thiệu một số thư viện thường gặp trong lập trình C++:</p>
                        </div>
                        <div style="height: 20px;"></div>
                        <div>
