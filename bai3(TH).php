...
int main()
{
    ...
    cout&lt;&lt;"chương trình này được đăng tại Freetuts.net";
                        ...
                        <div style="height: 20px;"></div>
                        <p>Như vậy là chúng ta đã thực hiện xong chương trình tìm số lớn nhất trong ba số trong C++. Chúc các bạn thực hiện thành công!!!</p>
                    </div>
               </div>
               <div style="height: 50px;"></div>
                <div style="height: 20px;"></div>
                ...
                <div style="float: left;width: 100%;display: flex;">
                    <p id="bt" ><a href="bai2(TH).html">⇦ Bài trước </a></p>
                    <p id="bs"><a href="bai4(TH).html">Bài tiếp theo ⇨</a></p>
                </div>
               <div style="height: 50px;"></div>
                </div>
