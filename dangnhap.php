...
<body class="container-fluid d-flex justify-content-center align-items-center row" style="background-color: #464545;">
    ...
    <div class="row" style="">
        <div class="container col-md-12 mt-2">
            <p class="styled-heading  " style="color: rgb(205, 239, 239);">ĐĂNG NHẬP TẠI ĐÂY</p>
            <i class="justify-content-center d-flex pb-2" style="color: rgb(175, 214, 201);">Hãy đến với chúng tôi </i>
        </div>
        <div class=" col-md-12 justify-content-center d-flex container mt-5" style="color: aliceblue;">
            <div class="form row" style="display: block;">
                    <form method="POST" action="findacc.php">
                        <div class="pb-2 chu1"><label for="tk"><b id="chua" >Tài Khoản: </b></label></div>
                        <div class="mb-3">
                            <input type="text" class="form-control" id="tk" name="taikhoan" placeholder="Tài Khoản">
                        </div>
                        <div class="pb-2 chu1 "><label for="tk"><b  id="chua">Mật Khẩu: </b></label></div>
                        <div class="mb-3 d-flex" style="clear: left;">
                        ...
                        <a class="pb-3 dangky chu1" style="text-decoration: none;color: rgb(50, 49, 49)" href="dangky.php"><i>Đăng Ký?</i></a>
                        <div class="ps-5 pb-3 pt-5">
