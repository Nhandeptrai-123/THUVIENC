...
cout&lt;&lt;"Chương trình này được đăng tại Freetuts.net";
                        ...
                        <div style="height: 20px;"></div>
                        <p>Như vậy là chúng ta đã thực hiện xong chương trình C++ để chuyển đổi chữ thường thành chữ hoa. Chúc các bạn thực hiện thành công!!!</p>
                    </div>
               </div>
                <div style="height: 20px;"></div>
                <hr>
                ...
                <div style="float: left;width: 100%;display: flex;">
                    <p id="bt" ><a href="bai7(TH).html">⇦ Bài trước </a></p>
                    <p id="bs"><a href="bai9(TH).html">Bài tiếp theo ⇨</a></p>
                </div>
               <div style="height: 50px;"></div>
                </div>
