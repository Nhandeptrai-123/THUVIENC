...
int main()
{
    ...
    cout&lt;&lt;"Chương trình này được đăng tại Freetuts.net";
                        ...
                        <div style="height: 20px;"></div>
                        <p>Đầu tiên chúng ta sẽ tạo một biến <strong>length </strong>để chứa độ dài của chuỗi, tạo một mảng <strong>str[]</strong> để chứa các phần tử trong chuỗi.</p>
                        <div style="height: 20px;"></div>
                        <p>Tiếp đến sẽ yêu cầu người dùng nhập vào chuỗi bằng cách sử dụng câu lệnh <strong>cout </strong>và <strong>cin.</strong></p>
                        <div style="height: 20px;"></div>
                        <p>Sử dụng hàm <strong>strlen()</strong> để đếm độ dài của chuỗi <strong>str[] </strong>rồi gán giá trị vừa đếm được vào biến <strong>length.</strong></p>
                        <div style="height: 20px;"></div>
                        <p>Cuối cùng hiển thị kết quả ra màn hình.</p>
                        <div style="height: 20px;"></div>
                        ...
                        <div style="height: 20px;"></div>
                        <p>Như vậy là chúng ta đã thực hiện xong chương trình để tìm độ dài của một chuỗi. Chúc các bạn thực hiện thành công!!!</p>
                    </div>
               </div>
                <div style="height: 20px;"></div>
                <hr>
                ...
                <div style="float: left;width: 100%;display: flex;">
                    <p id="bt" ><a href="bai5(TH).html">⇦ Bài trước </a></p>
                    <p id="bs"><a href="bai7(TH).html">Bài tiếp theo ⇨</a></p>
                </div>
               <div style="height: 50px;"></div>
                </div>
