...
<body>
 ...
 {   
    ...
    cout &#60;&#60; "Ban dang hoc series C++ can ban" &#60;&#60; endl;
               ...
               <div>
                    ...
                    <div style="height: 20px;"></div>
                    <div>
                        <p>Ngược với <b>cout, cin</b> dùng để nhập dữ liệu từ bàn phím hoặc file. Thông thường khi bạn học C++ căn bản thì sẽ nhập dữ liệu từ bàn phím để giải các bài toán căn bản.</p>
                    </div>
                    <div style="height: 20px;"></div>
                    <div>
                        <p>Để nhập dữ liệu từ bàn phím ta dùng cú pháp sau:</p>
                    </div>
                    <div style="height: 20px;"></div>
                    <div>
                        <textarea style="font-size: 20px;padding-top: 10px;padding-right: 50px;background-color:#222f3c;color: aliceblue;" name="code-1" id="code1" cols="70" rows="2  ">
 cin >> variable;
                    ...
                    <div style="height: 20px;"></div>
                    <div>
                        <p>Trong đó <b>variable</b>  ta gọi là biến.</p>
                    </div>
                    <div style="height: 20px;"></div>
                    <div>
                        <p>Trường hợp bạn muốn nhập nhiều giá trị cùng một lênh cin thì sử dụng cú pháp sau:</p>
                    </div>
                    <div style="height: 20px;"></div>
                    <div>
...
cin >> variable1 >> variable2 >> variable3;
                    ...
                    <div style="height: 20px;"></div>
                    <div>
                        <p>Trong bài này có lẽ bạn chưa hiểu khái niệm biến là gì, nếu vậy thì bạn hãy xem sơ lược qua ví dụ rồi ở bài tiếp theo chúng ta sẽ tìm hiểu đến nó.</p>
                    </div>
                    <div style="height: 20px;"></div>
                    <div>
                        <p> <b>Ví dụ:</b> Viết chương trình cho người dùng nhập vào một chuỗi rồi in chuỗi đó ra màn hình.</p>
                    </div>
                    <div style="height: 20px;"></div>
                    <div>
